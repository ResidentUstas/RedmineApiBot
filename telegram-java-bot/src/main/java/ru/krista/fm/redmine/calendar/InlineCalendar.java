...
import ru.krista.fm.redmine.calendar.utils.ButtonFactory;
import ru.krista.fm.redmine.calendar.utils.DaysAbbreviations;
import ru.krista.fm.redmine.calendar.utils.Locale;
import ru.krista.fm.redmine.calendar.utils.MonthAbbreviations;
...
public class InlineCalendar {
    ...
    protected static List<InlineKeyboardButton> createGetReportRow(LocalDate date) {
